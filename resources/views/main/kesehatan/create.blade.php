    ...
    <form id="formAdd">
        <div class="card">
            <div class="card-header">
                <div class="card-title">Data Kesehatan</div>
            ...
            <div class="card-body">
                <div class="form-group">
                    <input type="hidden" name="kategori" id="kategori" value="Kesehatan">
                    <label for="nama">Nama Kesehatan</label>
                    <input type="text" class="form-control nama" name="nama" id="nama" placeholder="masukkan nama kesehatan">
                    <div class="invalid-feedback error-nama"></div>
                </div>
                <div class="form-group">
                    <label for="alamat">Alamat Kesehatan</label>
