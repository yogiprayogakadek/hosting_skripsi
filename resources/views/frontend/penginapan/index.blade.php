...
<section class="bg-center py-0" id="about"
    ...
    <section class="about py-0">
        <div class="container">
            <p class="h6 text-uppercase text-primary">Failitas Penginapan</p>
        ...
        <div class="container py-5"> -->
                ...
                <div class="col-lg-6">
                    ...
                    <ul class="list-check">
                        <li class="text-muted mb-2">
                            Sekitar 30 menit berkendara dari Nusa Penida. Ke arah utara menuju Jl. Buyuk Limo - belok
                            kanan ke Jl. Nusa Indah - Jl. Ped-Buyuk - Jl. Raya Batumulapan sekitar 4,1 km, Pura Goa Giri
                            Putri berada di kanan jalan.
                        </li>
                        <li class="text-muted mb-2">
                            Jika pengunjung berangkat dari Bandar Udara Ngurah Rai maka harus menuju ke dermaga dan
                            ...
                            <div class="card border-0 shadow rounded-lg text-start px-2">
                                <div class="card-body">
                                    ...
                                    <p class="text-sm mb-0 text-muted">
                                        <img class="img-fluid"
                                            src="https://www.befreetour.com/laravel-filemanager/photos/Artikel%20Review/Bali/Goa%20Giri%20Putri/Pengunjung_tak_hanya_berwisata_tetapi_juga_datang_untuk_bersembahyang_-_Photo_by__orianna_bali_tours.jpg"
                                            alt="">
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6 col-sm-6">
                            ...
                            <div class="card border-0 shadow rounded-lg text-start px-2">
                                <div class="card-body">
                                    ...
                                    <p class="text-sm mb-0 text-muted">
                                        <img class="img-fluid"
                                            src="https://www.befreetour.com/laravel-filemanager/photos/Artikel%20Review/Bali/Goa%20Giri%20Putri/Kursi_-_kursi_panjang_dari_batu_yang_digunakan_untuk_persembahyangan_-_Photo_by__seviavera.jpg"
                                            alt="">
                                    </p>
                                </div>
                            </div>
            ...
            <div class="row align-items-center mb-5 gy-5">
                                            ...
                                            <div
                                                ...
                                                <div class="card-body index-forward pt-5 rounded-lg">
                                                    {{-- <div class="testimonial-img"><img class="rounded-circle"
                                                            src="https://d19m59y37dris4.cloudfront.net/app/2-0/img/avatar-1.a288a8c1.jpg"
                                                            alt="" width="100" /></div> --}}
                                                    <p class="lead text-muted mb-5">
                                                        Tahapan persembahyangan di Goa Giri Putri dimulai dengan menaiki
                                                        puluhan anak tangga
                                                        menuju tempat persembahyangan pertama yakni Pelinggih Ida Hyang
                                                        Tri Purusa Lan Ganapati,
                                    ...
                                    <div class="swiper-slide h-auto">
                                        <div class="mx-3 mx-lg-5 my-5 pt-3">
                                            <div
                                                ...
                                                <div class="card-body index-forward pt-5 rounded-lg">
                                                    {{-- <div class="testimonial-img"><img class="rounded-circle"
                                                            src="https://d19m59y37dris4.cloudfront.net/app/2-0/img/avatar-2.0af75238.png"
                                                            alt="" width="100" /></div> --}}
                                                    <p class="lead text-muted mb-5">Persembahyangan kedua dilaksanakan
                                                        untuk menghaturkan sembah bhakti di Pelinggih Ida Hyang Wisnu
                                                        dan Wasuki, serta terdapat pula lingga yoni yang melambangkan
                                                        stana Dewa Siwa yang letaknya tidak jauh dari pelinggih utama.
                                                    </p>
                                            ...
                                            <div
                                                ...
                                                <div class="card-body index-forward pt-5 rounded-lg">
                                                    {{-- <div class="testimonial-img"><img class="rounded-circle"
                                                            src="https://d19m59y37dris4.cloudfront.net/app/2-0/img/avatar-1.a288a8c1.jpg"
                                                            alt="" width="100" /></div> --}}
                                                    <p class="lead text-muted mb-5">Setelah itu dilanjutkan melakukan
                                                        prosesi ketiga, keempat, dan kelima yang letaknya tidak jauh
                                                        dari tempat persembahyangan kedua.
                                                    </p>
                                            ...
                                            <div
                                                ...
                                                <div class="card-body index-forward pt-5 rounded-lg">
                                                    {{-- <div class="testimonial-img"><img class="rounded-circle"
                                                            ...
                                                            alt="" width="100" /></div> --}}
                                                    <p class="lead text-muted mb-5">
                                                        Ketiga tempat tersebut merupakan Linggih Ida Hyang Dewi Gangga
                                                        (tempat melukat), Ida Hyang Giri Pati, dan Ida Hyang Giri Putri.
                                                        Pemedek diharuskan untuk melakukan penglukatan terlebih dahulu
                                                        sebelum melakukan persembahyangan. Penglukatan tersebut
                                                        dimaksudkan untuk memohon kepada Dewi Gangga agar secara lahir
                                                        batin terlepas dari hal-hal negatif.
                                                    </p>
                ...
                <div class="col-lg-4">
                    ...
                    <p class="text-muted">Tata cara dalam melakukan persembahyangan pada pura goa giri putri dapat
                        dilihat pada video berikut</p>
                    <button class="btn btn-primary js-modal-btn" data-video-id="B6uuIHpFkuo"><i
                            class="fas fa-play-circle me-2"></i>Play video</button>
                </div>
            </div>
