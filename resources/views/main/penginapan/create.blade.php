        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group">
                    <input type="hidden" name="kategori" id="kategori" value="Penginapan">
                    <label for="nama">Nama Penginapan</label>
                    <input type="text" class="form-control nama" name="nama" id="nama" placeholder="masukkan nama penginapan">
