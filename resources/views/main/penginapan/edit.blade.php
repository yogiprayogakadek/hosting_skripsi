    ...
    <form id="formEdit">
        <div class="card">
            <div class="card-header">
                <div class="card-title">Data Penginapan</div>
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control nama" name="nama" id="nama" placeholder="masukkan nama penginapan" value="{{$lokasi->nama}}">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control deskripsi" name="deskripsi" id="deskripsi" placeholder="masukkan deskripsi">{!!$lokasi->deskripsi!!}</textarea>
